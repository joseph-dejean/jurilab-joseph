...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary: Deep Burgundy / Red - #770722 main
        primary: {
          50: '#fff0f3',
          100: '#ffe3e8',
          200: '#ffcdd7',
          ...
          400: '#ba0c35',
          500: '#99092c',
          600: '#770722', // Main Brand Color
          700: '#5e061b',
          800: '#450413',
          900: '#36030f',
          950: '#2b020b',
        },
        // Accent: Warm Gold - Luxury accent (Kept from original)
        accent: {
          50: '#fefce8',
          100: '#fef9c3',
          200: '#fef08a',
        ...
        // Surface: Neutral White/Grey tones
        surface: {
          50: '#ffffff',
          100: '#fafafa',
          200: '#f5f5f5',
        ...
        // Deep: Neutral Slate/Dark Grey for text and dark elements
        deep: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      boxShadow: {
        ...
        'glow': '0 0 40px rgba(119, 7, 34, 0.15)',
